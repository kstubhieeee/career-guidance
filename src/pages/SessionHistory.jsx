...
function SessionHistory() {
  ...
  const filteredBookings = bookings.filter(booking => {
    ...
    if (activeFilter === 'upcoming') return booking.status === 'confirmed' || booking.status === 'accepted';
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex border-b border-gray-700 mb-6 overflow-x-auto">
              {['all', 'upcoming', 'completed', 'pending'].map((filter) => (
                <button
                  key={filter}
            ...
            {filteredBookings.length > 0 ? (
                  ...
                  <div key={booking._id} className="bg-secondary-light rounded-lg shadow-xl overflow-hidden">
                    <div className="p-6">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2 border-t border-gray-700">
                        {/* Show Join Session button for paid/confirmed sessions not completed/cancelled */}
                        {booking.paymentId && booking.paymentId !== 'pending' &&
                          booking.status !== 'completed' && booking.status !== 'cancelled' && (
                            <button
                              ...
                              className="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 transition-all flex items-center gap-1 text-sm"
                            >
              ...
              <div className="bg-secondary-light rounded-lg shadow-xl p-8 text-center">
                ...
                <h2 className="text-2xl font-bold text-white mb-2">No {activeFilter} sessions found</h2>
                <p className="text-gray-300 mb-6">
                  ...
                  {activeFilter === 'all' && "No sessions match the current filter."}
                </p>

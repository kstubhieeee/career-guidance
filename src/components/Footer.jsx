        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Empowering you to make informed career decisions with personalized guidance and resources.
            </p>
            <div className="flex space-x-3">
              <a href="#" className="bg-secondary w-10 h-10 rounded-full flex items-center justify-center hover:bg-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/interests" className="text-gray-400 hover:text-primary transition-colors">Explore Interests</Link>
              </li>
              <li>
                <Link to="/mcq" className="text-gray-400 hover:text-primary transition-colors">Assessment</Link>
              </li>
              <li>
                <Link to="/find-mentors" className="text-gray-400 hover:text-primary transition-colors">Find Mentors</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Subscribe to our newsletter for the latest career insights and opportunities.</p>
            <form className="flex flex-col space-y-3">
              <input 
                type="email" 
                placeholder="Your email address" 
                className="px-4 py-2 bg-darkblue text-white rounded-lg border border-gray-700 focus:outline-none focus:border-primary"
              />
              <button 
                type="submit" 
